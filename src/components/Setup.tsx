        ...
        <form onSubmit={handleSubmit} className="space-y-6">
           <div>
            ...
            <input 
              ...
              className="w-full bg-[#121620] border-b-2 border-bg-border text-text-primary p-4 rounded-t-lg focus:outline-none focus:border-blue-500 transition-colors placeholder:text-zinc-600"
              value={name}
              onChange={(e) => {
          ...
          <button 
            type="submit"
            className="w-full py-4 rounded-xl bg-blue-600 text-text-primary font-semibold flex items-center justify-center gap-2 hover:bg-blue-500 transition-colors shadow-lg shadow-blue-500/20 mt-4"
          >
            Continue
