  ...
  return (
    <div className="space-y-5 animate-in fade-in duration-500 pb-6">
      <div className="pt-2 pb-2">
         ...
         <p className="text-[15px] font-medium text-[#5e7194] mt-1">Domain optimization for {domain}</p>
      </div>

      {loading && (
        <div className="w-full bg-[#131823] border border-[#1e2433] rounded-[24px] p-10 flex flex-col items-center justify-center space-y-4 shadow-sm">
          <div className="w-16 h-16 bg-[#1a2130] rounded-full flex items-center justify-center">
             <Loader2 className="w-8 h-8 text-[#3c78d8] animate-spin" />
          </div>
          <p className="text-[#8ca0c9] text-[15px] font-medium animate-pulse">Running domain algorithms...</p>
        </div>
      )}
      ...
      {analysis && !loading && (
        <div className="space-y-4 animate-in slide-in-from-bottom-4 duration-500">
          ...
          <div className="bg-gradient-to-br from-[#1c2233] to-[#131823] border border-[#1e2433] rounded-[24px] p-6 shadow-sm">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="font-bold text-[18px] text-white">Assessment</h3>
            </div>
            <p className="text-[15px] leading-relaxed text-[#c1d0eb]">{analysis.summary}</p>
          </div>

          <div className="bg-[#131823] rounded-[24px] p-6 border border-[#1e2433] shadow-sm">
            ...
            <p className="text-[15px] text-[#8ca0c9] leading-relaxed">{analysis.constructiveSuggestion}</p>
          </div>
          ...
          <button 
            ...
            className="mt-6 flex items-center justify-center gap-2 text-[14px] text-[#5e7194] font-medium w-full py-4 uppercase tracking-widest hover:text-[#8ca0c9] transition-colors"
          >
